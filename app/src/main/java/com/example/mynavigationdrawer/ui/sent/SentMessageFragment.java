...
public class SentMessageFragment extends Fragment {
    ...
    private SentMessageViewModel sentMessageViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        sentMessageViewModel =
                ViewModelProviders.of(this).get(SentMessageViewModel.class);
        View root = inflater.inflate(R.layout.fragment_sent, container, false);
        final TextView textView = root.findViewById(R.id.text_slideshow);
        sentMessageViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
